        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="学员端" name="first">
                ...
                <el-table ref="multipleTable" :data="tableData3" border tooltip-effect="dark" style="width: 100%">
                    <el-table-column prop="num" align='center' label="顺序" min-width="40">
                    </el-table-column>
                    <el-table-column prop="topic" align='center' label="主题" min-width="50">
                    </el-table-column>
                    ...
                    <el-table-column prop="status" align='center' label="状态" min-width="40" show-overflow-tooltip>
                    </el-table-column>
